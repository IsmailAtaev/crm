                              ...
                              <Stack direction="row" spacing={1}>
                                <IconButton>
                                  <Link
                                    ...
                                    target="_blank"
                                    // to={`http://192.168.1.138/files/${doc.pathPdf}`}
                                    to={`http://localhost:5022/files/${doc.pathPdf}`}
                                  >
                                    <RemoveRedEyeIcon
                                      sx={{ color: "#9FA1C2" }}
                                    />
                          ...
                          <>
                            ...
                            <IconButton>
                              <Link
                                ...
                                target="_blank"
                                to={`http://localhost:5022/files/${elem.pdfDocuments[0].pathPdf}`}
                              // to={`http://192.168.1.138/files/${elem.pdfDocuments[0].pathPdf}`}
                              >
                                <RemoveRedEyeIcon sx={{ color: "#9FA1C2" }} />
                              </Link>
                            </IconButton>
