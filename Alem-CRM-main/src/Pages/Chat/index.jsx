...
import { Modal, Box, Typography, IconButton, Stack, Avatar, TextField, } from "@mui/material"; // Импортируйте необходимые компоненты из MUI
                  ...
                  >
                    {user.img ? (
                      <img
                        ...
                        src={`http://localhost:5022/images/${user.img}`}
                        // src={`http://192.168.1.138/images/${user.img}`}
                        alt=""
                      />
                    ) : (
                      <Avatar
                ...
                >
                  {name.img != null ? (
                    <img
                      ...
                      src={`http://localhost:5022/images/${name.img}`}
                      // src={`http://192.168.1.138/images/${name.img}`}
                      alt=""
                    />
                  ) : (
                    <Avatar
